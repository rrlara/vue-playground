...
<div class="cardContainer"  :item="item">
        <header>
            <div class="bio">
        <img  v-lazy="item.properties.attributes.thumbnail._url" alt="background" class="bg">
                <div class="desc">
                    <h3>@carlf</h3>
                    <p>{{item.properties.attributes.comment}}</p>
                    <!-- <mini-map @click="getMap()" :item="item"></mini-map> -->
                </div>
            </div>
        ...
        <div class="content">
            <div class="data">
                <ul>
                    <li>
                        {{item.properties.attributes.latitude}}
                        <span>Latitude</span>
                    </li>
                    <li>
                        {{item.properties.attributes.longitude}}
                        <span>Longitude</span>
                    </li>
                    <li>
                        {{item.properties.attributes.altitude}}
                        <span>Altitude</span>
                    </li>
                </ul>
            </div>
...
import MiniMap from './MapInsetView.vue'
